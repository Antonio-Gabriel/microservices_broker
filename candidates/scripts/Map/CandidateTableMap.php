...
class CandidateTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.CandidateTableMap';

    /**
     * The default database name for this class
     */
    public const DATABASE_NAME = 'candidates';

    /**
     * The table name for this class
     */
    public const TABLE_NAME = 'candidate';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Candidate';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Candidate';
     ...
     */
    public const COL_ID = 'candidate.id';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'candidate.name';

    /**
     * the column name for the category_id field
     */
    public const COL_CATEGORY_ID = 'candidate.category_id';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Name', 'CategoryId', ],
        self::TYPE_CAMELNAME     => ['id', 'name', 'categoryId', ],
        self::TYPE_COLNAME       => [CandidateTableMap::COL_ID, CandidateTableMap::COL_NAME, CandidateTableMap::COL_CATEGORY_ID, ],
        self::TYPE_FIELDNAME     => ['id', 'name', 'category_id', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Name' => 1, 'CategoryId' => 2, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'name' => 1, 'categoryId' => 2, ],
        self::TYPE_COLNAME       => [CandidateTableMap::COL_ID => 0, CandidateTableMap::COL_NAME => 1, CandidateTableMap::COL_CATEGORY_ID => 2, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'name' => 1, 'category_id' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'candidate.id' => 'ID',
        'CandidateTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'Name' => 'NAME',
        'Candidate.Name' => 'NAME',
        'name' => 'NAME',
        'candidate.name' => 'NAME',
        'CandidateTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
        'CategoryId' => 'CATEGORY_ID',
        'Candidate.CategoryId' => 'CATEGORY_ID',
        'categoryId' => 'CATEGORY_ID',
        'candidate.categoryId' => 'CATEGORY_ID',
        'CandidateTableMap::COL_CATEGORY_ID' => 'CATEGORY_ID',
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\Candidate');
        $this->setPackage('');
        $this->setUseIdGenerator(false);
        // columns
        $this->addPrimaryKey('id', 'Id', 'VARCHAR', true, 255, null);
        $this->addColumn('name', 'Name', 'VARCHAR', true, 80, null);
        $this->addForeignKey('category_id', 'CategoryId', 'VARCHAR', 'category', 'id', true, 255, null);
    }
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CandidateTableMap::COL_NAME);
            $criteria->addSelectColumn(CandidateTableMap::COL_CATEGORY_ID);
        } else {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(CandidateTableMap::COL_ID);
            $criteria->removeSelectColumn(CandidateTableMap::COL_NAME);
            $criteria->removeSelectColumn(CandidateTableMap::COL_CATEGORY_ID);
        } else {
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Candidate) { // it's a model object
