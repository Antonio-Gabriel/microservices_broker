...
abstract class Candidate implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\CandidateTableMap';
    ...
    /**
     * Initializes internal state of Base\Candidate object.
     */
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[CandidateTableMap::COL_NAME] = true;
        }
    ...
    public function setCategoryId($v)
    {
        ...
        if ($this->category_id !== $v) {
            $this->category_id = $v;
            $this->modifiedColumns[CandidateTableMap::COL_CATEGORY_ID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CandidateTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CandidateTableMap::translateFieldName('CategoryId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Candidate'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(CandidateTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(CandidateTableMap::COL_CATEGORY_ID)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(CandidateTableMap::COL_NAME)) {
            $criteria->add(CandidateTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(CandidateTableMap::COL_CATEGORY_ID)) {
            $criteria->add(CandidateTableMap::COL_CATEGORY_ID, $this->category_id);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Candidate (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Candidate Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function getCategory(?ConnectionInterface $con = null)
    {
        if ($this->aCategory === null && (($this->category_id !== "" && $this->category_id !== null))) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCategory->addCandidates($this);
             */
        }
    ...
    {
        if (null !== $this->aCategory) {
            $this->aCategory->removeCandidate($this);
        }
        $this->id = null;
        $this->name = null;
