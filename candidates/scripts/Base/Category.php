...
abstract class Category implements ActiveRecordInterface
{
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildCandidate> Collection to store aggregation of ChildCandidate objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildCandidate>
     */
     ...
     * @return void
     */
    public function resetPartialCandidates($v = true): void
    {
     ...
     * @return void
     */
    public function initCandidates(bool $overrideExisting = true): void
    {
        ...
        $this->collCandidates->setModel('\Candidate');
    }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildCandidate> List of ChildCandidate objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collCandidates || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collCandidates) {
                    ...
                    $collCandidates = new $collectionClassName;
                    $collCandidates->setModel('\Candidate');
    ...
    public function setCandidates(Collection $candidates, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($candidatesToDelete as $candidateRemoved) {
            $candidateRemoved->setCategory(null);
        }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countCandidates(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collCandidatesPartial && !$this->isNew();
        if (null === $this->collCandidates || null !== $criteria || $partial) {
     ...
     */
    protected function doAddCandidate(ChildCandidate $candidate): void
    {
